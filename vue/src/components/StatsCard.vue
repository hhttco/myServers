        ...
        <div class="hero-card">
          ...
          <div class="value" style="display: block">
            <div>
              ...
              <span style="font-size: 14px; color: #d09453">
                {{ formatBytes(stats.traffic_up) }}</span
              >
              &nbsp;
              <icon-arrow-down style="font-size: 14px; color: #9a5fcd" />
              <span style="font-size: 14px; color: #9a5fcd">{{
